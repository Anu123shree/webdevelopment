...
password = '12345'                               # e.g. password = '1234'
database_name = 'data1'                                 # e.g. database_name = 'database_1A'
edit_mode_password = '12345'                               # e.g. edit_mode_password = 'allow_edit'
dr_mls_access_code = '12345'      # e.g. dr_mls_access_code = 'access_auth'
